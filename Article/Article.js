...
const data = [
  ...
  {
    title: 'How to be a bro in 2020.',
    date: 'Feb 12th, 2020',
    firstParagraph: 'Two words: Instagram gym pics'
  },
  {
    title: 'Clout Chasing 101.',
    date: 'Feb 12th, 2020',
    firstParagraph: 'Spend all your money on clothes and a nice car and go broke.'
  }
];
...
data.map(element => {
  mainContainer.appendChild(createBox(element));
});
